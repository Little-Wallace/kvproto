...
func (PeerState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_e205a1b98954fcde, []int{0}
}
...
func (ExtraMessageType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_e205a1b98954fcde, []int{1}
}
...
func (*SnapshotCFFile) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_e205a1b98954fcde, []int{2}
}
...
func (*SnapshotMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_e205a1b98954fcde, []int{3}
}
...
func (*SnapshotChunk) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_e205a1b98954fcde, []int{4}
}
...
func (*Done) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_e205a1b98954fcde, []int{5}
}
...
func (*KeyValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_e205a1b98954fcde, []int{6}
}
...
func (m *StatisticCache) Reset()         { *m = StatisticCache{} }
func (m *StatisticCache) String() string { return proto.CompactTextString(m) }
func (*StatisticCache) ProtoMessage()    {}
func (*StatisticCache) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_e205a1b98954fcde, []int{7}
}
func (m *StatisticCache) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *StatisticCache) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_StatisticCache.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *StatisticCache) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StatisticCache.Merge(dst, src)
}
func (m *StatisticCache) XXX_Size() int {
	return m.Size()
}
func (m *StatisticCache) XXX_DiscardUnknown() {
	xxx_messageInfo_StatisticCache.DiscardUnknown(m)
}

var xxx_messageInfo_StatisticCache proto.InternalMessageInfo

func (m *StatisticCache) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
func (m *StatisticCache) GetAppliedIndex() uint64 {
	if m != nil {
...
type RaftSnapshotData struct {
	...
	StatisticCache       *StatisticCache `protobuf:"bytes,6,opt,name=statistic_cache,json=statisticCache" json:"statistic_cache,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (*RaftSnapshotData) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_e205a1b98954fcde, []int{8}
}
...
func (m *RaftSnapshotData) GetStatisticCache() *StatisticCache {
	if m != nil {
		return m.StatisticCache
	}
	return nil
}
...
func (*StoreIdent) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_e205a1b98954fcde, []int{9}
}
...
func (*RaftLocalState) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_e205a1b98954fcde, []int{10}
}
...
type RaftApplyState struct {
	...
	LastDataIndex        uint64              `protobuf:"varint,6,opt,name=last_data_index,json=lastDataIndex,proto3" json:"last_data_index,omitempty"`
...
func (*RaftApplyState) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_e205a1b98954fcde, []int{11}
}
...
func (m *RaftApplyState) GetLastDataIndex() uint64 {
	if m != nil {
		return m.LastDataIndex
	}
	return 0
}
...
func (*MergeState) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_e205a1b98954fcde, []int{12}
}
...
func (*RegionLocalState) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_e205a1b98954fcde, []int{13}
}
...
func (*ExtraMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_serverpb_e205a1b98954fcde, []int{14}
}
...
func init() {
	...
	proto.RegisterType((*StatisticCache)(nil), "raft_serverpb.StatisticCache")
...
func (m *StatisticCache) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *StatisticCache) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *RaftSnapshotData) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StatisticCache != nil {
		dAtA[i] = 0x32
		i++
		i = encodeVarintRaftServerpb(dAtA, i, uint64(m.StatisticCache.Size()))
		n10, err := m.StatisticCache.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
func (m *RaftLocalState) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.HardState != nil {
		...
		n11, err := m.HardState.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
...
func (m *RaftApplyState) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TruncatedState != nil {
		...
		n12, err := m.TruncatedState.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
	...
	if m.LastDataIndex != 0 {
		dAtA[i] = 0x30
		i++
		i = encodeVarintRaftServerpb(dAtA, i, uint64(m.LastDataIndex))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *RegionLocalState) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MergeState != nil {
		...
		n15, err := m.MergeState.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
...
func (m *StatisticCache) Size() (n int) {
	var l int
	_ = l
	l = len(m.Data)
	if l > 0 {
...
func (m *RaftApplyState) Size() (n int) {
	...
	if m.LastDataIndex != 0 {
		n += 1 + sovRaftServerpb(uint64(m.LastDataIndex))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *StatisticCache) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StatisticCache: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StatisticCache: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RaftSnapshotData) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StatisticCache", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.StatisticCache == nil {
				m.StatisticCache = &StatisticCache{}
			}
			if err := m.StatisticCache.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *RaftApplyState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastDataIndex", wireType)
			}
			m.LastDataIndex = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LastDataIndex |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func init() { proto.RegisterFile("raft_serverpb.proto", fileDescriptor_raft_serverpb_e205a1b98954fcde) }

var fileDescriptor_raft_serverpb_e205a1b98954fcde = []byte{
	// 1254 bytes of a gzipped FileDescriptorProto
	,
}
